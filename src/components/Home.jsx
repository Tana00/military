...
const Home = ({setOpenForm}) => {
  ...
  return (
    <div className="min-h-screen w-full dark:bg-[#0c2b2f] bg-[#0c2b2f] dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative flex flex-col items-center justify-center md:justify-end overflow-clip">
