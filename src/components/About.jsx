...
const About = () => {
  return (
    <div
      id="target-section"
      className="min-h-screen w-full flex flex-col justify-center items-center text-center text-7xl bg-white px-2 md:px-4 py-20"
    >
      <div className="w-full h-full flex flex-col gap-4 md:gap-16 px-4">
